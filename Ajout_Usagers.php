...
<html>
    ...
    <?php 
		...
		if(isset($_POST['Ajouter'])) {
			...
			if($data[0]==null) {
				$req = $r -> prepare('INSERT INTO usager (idU,civilite,nom,prenom,adresse,codeP, dateN,lieuN,numS,idM) VALUES ('',:civilite, :nom, :prenom, :adresse, :codeP, :dateN, :lieuN, :numS, :idM)'); 
