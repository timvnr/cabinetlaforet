...
<html>
    ...
    <?php
		...
		if(isset($_POST['Ajouter'])) {
			...
			$res2 = $linkpdo->query("SELECT idM FROM medecin WHERE nom='$nom' and prenom='$prenom'");
			$data = $res2->fetch();
			...
			if($data['idM']==null) {
				...
				$res = $linkpdo->exec("INSERT INTO medecin(idM, civilite, nom, prenom) VALUES('$id', '$civilite', '$nom', '$prenom')");
